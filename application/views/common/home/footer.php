    ...
    <!-- Accepted cards end -->
      <section class="ct-subfoot">
        <div class="container">
            <div class="row">
                <div class="col-sm-6">
                    <div class="copy-text">© Rohullah Amin 2021. All Rights Reserved.  <?php //if(isset($this->config->item('site_settings')->rights_reserved_content)) echo $this->config->item('site_settings')->rights_reserved_content;?>&nbsp;</div>
                </div>
