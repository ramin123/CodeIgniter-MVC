<div id="page-wrapper">
            <div class="row">
            	...
            	<a title="<?php echo get_languageword('add_single_record'); ?>" class="btn btn-primary btn-xs pull-right" href="<?php echo URL_ADDEDIT_CARD; ?>"><i class="fa fa-plus"></i> </a>
			...
			<table id="example" class="display responsive nowrap" width="100%" cellspacing="0">
			  	<thead>
					<tr>
						...
						<th><?php echo get_languageword('card_image');?></th>
						<th><?php echo get_languageword('alternative_text');?></th>
