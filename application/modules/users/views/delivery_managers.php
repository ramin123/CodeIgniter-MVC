<div id="page-wrapper">
            ...
            <div class="row">
				...
				<a title="<?php echo get_languageword('add_record'); ?>" class="btn btn-primary btn-xs pull-right" href="<?php echo URL_ADDEDIT_DELIVERY_MANAGER;?>"><i class="fa fa-plus"></i> </a>
